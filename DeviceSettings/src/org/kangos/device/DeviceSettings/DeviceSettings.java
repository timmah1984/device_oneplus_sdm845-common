...
import org.kangos.device.DeviceSettings.doze.DozeSettingsActivity;
import org.kangos.device.DeviceSettings.preferences.ProperSeekBarPreference;
import org.kangos.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import org.kangos.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import org.kangos.device.DeviceSettings.preferences.VibratorStrengthPreference;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.kangos.device.DeviceSettings.HBMModeService.class);
            if (enabled) {
